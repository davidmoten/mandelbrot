 ...
 * using the basic {@link DoubleDouble} arithmetic operations.
 * 
 * @author Martin Davis
 *
 */
  ...
  extends TestCase
{
	...
	public DoubleDoubleComputeTest(String name) { super(name); }
   ...
   *    
	...
	private DoubleDouble computePiByMachin()
	{
		...
		DoubleDouble pi4 = (DoubleDouble.valueOf(4.0)
												.multiply(arctan(t1)))
												.subtract(arctan(t2));
   ...
   *    
	...
	private DoubleDouble arctan(DoubleDouble x)
	{
	  ...
	  System.out.println("Computed: " + at 
