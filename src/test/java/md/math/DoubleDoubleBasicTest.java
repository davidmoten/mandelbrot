  ...
  extends TestCase
{
  ...
  public DoubleDoubleBasicTest(String name) { super(name); }
...
//  	checkBinomialSquare(1e16, 1.0);
  ...
  private void checkMultiplyDivide(DoubleDouble a, DoubleDouble b, double errBound)
  {
  	DoubleDouble a2 = a.multiply(b).divide(b);
  	checkErrorBound("MultiplyDivide", a, a2, errBound);
  }

  private void checkDivideMultiply(DoubleDouble a, DoubleDouble b, double errBound)
  {
  ...
  private void checkErrorBound(String tag, DoubleDouble x, DoubleDouble y, double errBound)
  {
